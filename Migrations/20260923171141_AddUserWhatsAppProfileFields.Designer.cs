...
namespace Medshop.Migrations
{
    ...
    [Migration("20260923171141_AddUserWhatsAppProfileFields")]
    partial class AddUserWhatsAppProfileFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Medshop.Modules.Identity.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("WhatsAppBaseUrl")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("Medshop.Modules.Sales.Domain.Entities.Sale", b =>
                {
                    ...
                    b.Property<string>("DiseaseIllness")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("disease_illness");
