...
using Medshop.Modules.Categories.Application.Services;
...
using Medshop.Modules.Sales.Application.Services;
...
try
{
    ...
    builder.Services.AddScoped<IValidator<CustomSalesReportRequest>, CustomSalesReportRequestValidator>();
